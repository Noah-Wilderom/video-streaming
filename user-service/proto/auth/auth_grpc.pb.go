...
type AuthServiceClient interface {
	...
	Check(ctx context.Context, in *CheckRequest, opts ...grpc.CallOption) (*LoginResponse, error)
}
...
func (c *authServiceClient) Check(ctx context.Context, in *CheckRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	out := new(LoginResponse)
...
type AuthServiceServer interface {
	...
	Check(context.Context, *CheckRequest) (*LoginResponse, error)
...
func (UnimplementedAuthServiceServer) Check(context.Context, *CheckRequest) (*LoginResponse, error) {
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "shared/auth/auth.proto",
}
